#
#  Be sure to run `pod spec lint react-native-baidumap-s.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "react-native-baidumap-s"
  s.version      = "1.0.0"
  ...
  s.homepage     = "https://github.com/sujiewen/react-native-baidumap-s.git"
  ...
  s.source       = { :git => "https://github.com/sujiewen/react-native-baidumap-s.git", :tag => "#{s.version}" }
  ...
  s.dependency 'BMSLocationKit', '1.3.0.1'
end
